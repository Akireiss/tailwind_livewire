            ...
            <div class="lg:col-span-5">
              <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-5">
                <div class="md:col-span-5">
                  ...
                  <input type="text" name="product_name" id="full_name" class="h-10 border mt-1 rounded px-4 w-full bg-gray-50" value="" />
                </div>
                ...
                <div class="md:col-span-5">
                    ...
                    <p class="mt-1 text-sm text-gray-500 dark:text-gray-300 mb-1" id="file_input_help">SVG, PNG, JPG or GIF (MAX. 800x400px).</p>
                    </div>


                <div class="md:col-span-5">
                  <label for="price">Price</label>
                  <input type="text" name="price" id="price" class="h-10 border mb-2 rounded px-4 w-full bg-gray-50" value="" placeholder="" />
                </div>
                  </div>
                </div>
